...
//     - can be 0.5 increments
// - user can enter RIR between 0-6
//     - can be 0.5 increments

// Normal RM
// - if the checkbox is NOT checked for weighted pull up/dip it should only take in the following parameters:
//     - weight
//     - reps
//     - RPE

// Weighted pull up/dip RM
// - if the checkbox is checked for weighted pull ups/dips it should take in the following parameters:
//     - weight
//     - reps
//     - RPE
//     - bodyweight
//     - percentageOfBodyweight, defaults to 100%

// EXAMPLE (isWeightedBodyweight === true)
// weight: 100 lb
// reps: 3
// RPE: 8
...
// Calculations
// if isWeightedBodyweight === true:
//     totalWeight = weight + bodyweight
//                 = 100 + 195

//     mapping step that finds 3 reps at 8.5 intensity
//     percentage = .863

//     1rm = (totalWeight / percentage) - bodyweight   
//         = (295 / .863) - 195
//         = 146.83
...
// Result
// 100 lb x 3 reps @ RPE 8 equals
// 147 lb



// EXAMPLE (isWeightedBodyweight === false)
// weight: 100 lb
// reps: 3
// RPE: 8
