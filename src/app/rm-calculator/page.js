...
function CalculatorComponent() {
    ...
    const adjustedIntensityChartValues = intensityChartData.map((row) => ({
        ...row,
        adjustedIntensityChartValues:
            intensityChartUnit === "RIR" ? 10 - row.value : row.value,
    }));
        ...
        if (intensityUnit === "RPE") {
            if (
                ...
                const clampedValue = Math.min(
                    10,
                    Math.max(4, Math.round(numericValue * 2) / 2)
                );
                setIntensity(
                    clampedValue % 1 === 0
    ...
    const [calculatorType, setCalculatorType] = useState(
        calculatorParam === "Weight-for-Reps"
            ...
            <div className="rm-calculation-container">
                <div className="header-container">
                    ...
                    >
                        ...
                        <div className="custom-select-options">
                            <Link
                                href="/rm-calculator?calculator=1RM"
                            ...
                            <Link
                                href="/rm-calculator?calculator=Weight-for-Reps"
                                onClick={() => setIsOpen(false)}
                                className={
                                    calculatorType ===
                                    "Weight for Reps Calculator"
                ...
                <div className="result-container">
                    {calculatorType === "1 RM Calculator" && (
                        <div className="result-container-calculator">
                            <div>
                                {displayedWeight} {weightUnit.toLowerCase()} x{" "}
                                {displayedReps} reps @ {intensityUnit}{" "}
                                {intensity} equals
                            </div>
                            <h1>
                                {oneRepMax} {weightUnit.toLowerCase()}
                            </h1>
                        </div>
                    )}
                    ...
                    {calculatorType === "Weight for Reps Calculator" && (
                        <div className="result-container-calculator">
                            ...
                            <h1>
                                {weightForReps} {weightUnit.toLowerCase()}
                            </h1>
                            <div>
                                for {displayedTargetReps} reps @ {intensityUnit}{" "}
                                {targetIntensity}
                            </div>
                        </div>
                    )}
                ...
                <div className="data-container">
                    <div className="weight-container">
                        {calculatorType === "Weight for Reps Calculator" && (
                            <div
                                id="weight-for-reps-calculator"
                                className="reps-and-intensity-container"
                            >
                                <label>Targets</label>
                                ...
                                <div className="intensity-container">
                                    ...
                                    <input
                                        ...
                                        onChange={(e) =>
                                            handleTargetIntensityValueChange(
                                                e.target.value
                                            )
                                        }
                                        onBlur={handleTargetIntensityBlur}
                                        ref={targetIntensityInputRef}
                                        onKeyDown={(e) =>
                                            handleEnterKey(e, weightInputRef)
                                        }
                                    />
                                </div>
                                <span></span>
                                <label className="known-rm-label">
                                    Known RM
                                </label>
                            </div>
                        )}
                        <input
                            className="weight-input inputValueClear"
                            type="text"
                            inputMode="decimal"
                            pattern="[0-9]*\.?[0-9]*"
                            value={weight}
                            ...
                            placeholder="Weight"
                            ref={weightInputRef}
                            onKeyDown={(e) => handleEnterKey(e, repsInputRef)}
                        />
                    ...
                    <div className="reps-and-intensity-container">
                        <div className="reps-input-container">
                            <input
                                ...
                                ref={repsInputRef}
                                onKeyDown={(e) =>
                                    handleEnterKey(e, intensityInputRef)
                                }
                            />
                        </div>
                        <div className="intensity-container">
                            ...
                            <input
                                ...
                                value={intensity}
                                onChange={(e) =>
                                    handleIntensityValueChange(e.target.value)
                                }
                    ...
                    <div className="weighted-pull-up-container">
                                ...
                                {isAdvVisible && (
                                    <div className="percentage-container">
                                        ...
                                        <input
                                            ...
                                            onChange={(e) =>
                                                handlePercentageOfBodyweightChange(
                                                    e.target.value
                                                )
                                            }
                                        />
                        ...
                        {isWeightedBodyweight && isAdvVisible && (
                            <ul className="advanced-settings-list">
                                <li>
                                    Adjust % of your BW to include in total
                                    weight.
                                </li>
                                <li>
                                    Ex: Weighted Push Ups: count 60% of your BW
                                    since you aren&apos;t lifting weight of your
                                    legs.
                                </li>
                            </ul>
                        )}
                ...
                <table>
                    <thead>
                        <tr>
                            <th>
                                <select
                                    value={intensityChartUnit}
                                    onChange={(e) =>
                                        setIntensityChartUnit(e.target.value)
                                    }
                                >
                                    <option value="RPE">RPE</option>
                                    <option value="RIR">RIR</option>
                    ...
                    <tbody>
                        {adjustedIntensityChartValues.map((row, index) => (
                            <tr key={index}>
                                <td className="intensity-chart-intensity-column">
                                    {row.adjustedIntensityChartValues}
                                </td>
            ...
            <div className="info-bottom-section">
                {calculatorType === "1 RM Calculator" && (
                    <div className="calculator-info-bottom-section">
                        ...
                        <p>
                            For best accuracy, use set with lower reps done
                            close to failure.
                        </p>
                        <h3>How to Use</h3>
                        <ul>
                            ...
                            <li>
                                Enter the RPE (4-10) or RIR (0-6) in 0.5
                                increments.
                            </li>
                        </ul>
                    </div>
                ...
                {calculatorType === "Weight for Reps Calculator" && (
                    <div className="calculator-info-bottom-section">
                        ...
                        <p>
                            Find the weight you can lift for a given number of
                            reps.
                        </p>
                        <p>
                            <strong>Ex:</strong> Find 5 rep max @ RPE 9 using
                            any known rep max.
                        </p>
                        <h3>How to Use</h3>
                        <h4>Targets</h4>
